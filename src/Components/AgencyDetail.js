    ...
    async function GetProfileInfo() {
      try {
        const response = await Axios.get(
          `http://127.0.0.1:8000/api/profiles/${params.id}/` // import useParams and do this in order to you know what..
        );
  ...
  return (
    <div>
      ...
      >
        ...
        <Grid item={{ marginTop: "1rem", padding: "5px" }}>
            ...
            >
              <Card>
                <CardMedia
                  ...
                  height="140"
                  image={
                    `http://localhost:8000${listing.picture1}` // i don't understand why this like this  but okay
