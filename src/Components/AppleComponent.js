...
function AppleComponent() {
  const [numberOfApples, setnumberOfApples] = useState(0); // initial value of apples
  ...
  function tooManyDisplay() {
    if (numberOfApples > 10) return <h1>John has too many apples</h1>;
    else return ""; // telling react to do nothing
  }
